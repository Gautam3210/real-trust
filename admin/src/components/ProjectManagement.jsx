...
function ProjectManagement() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const {data} = await axios.post(backendUrl+"/api/projects", formData, {
        headers: {
      ...
      console.log("Response from backend:", data.success);
  ...
  return (
    <div className="project-container">
      ...
      <form onSubmit={handleSubmit} className="project-form">
        ...
        {preview && <img src={preview} alt="Preview" className="project-image-preview" />}
